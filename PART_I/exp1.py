...
distance0 = 1 # distance between peaks, increased for faster results but ! not missing the peaks
distance1 = 10 # distance between peaks, increased for faster results but ! not missing the peaks
...
folder_name = f"exp1_loc_{location}_wind_{time_window_size}_meth_{processing_method}_nperseg_{nperseg}"
