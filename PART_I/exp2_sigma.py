...
folder_name = f"exp2_sigma_loc_{location}_wind_{time_window_size}_meth_{processing_method}_vary"
...
fig, ax = plt.subplots(len(sigma_list), 2, figsize=(8, 10))
for i, sigma in enumerate(sigma_list):
    ...
    ax[i,0].scatter(freqs[peaks], P3[peaks], color='k', marker='x', label='Peaks')

    ax[i,0].set_title(f"sigma = {sigma}")
...
fig.tight_layout()
visualizer._save_figure(fig, f"PP_index_compare_nperseg_{nperseg}_sigma", folder_name)